...
mesh = Mesh("/home/jun/Documents/Magneto/FEniCSSimulations/AutoWriter/mesh/composition_Str_L.xml") # Load mesh
...
class Lshape_out(SubDomain):
    def inside(self, x, on_boundary):
        return on_boundary and ((0.84 < x[0] < 1.05 and near(x[1], topBound)))
...
if __name__ == "__main__":
    ...
    outerFolderName = "output/GNN_database_dis/GNN_simulation_output/Lshape_bigSimu_com_dis_div/"
