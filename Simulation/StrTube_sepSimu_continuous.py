...
#mesh = RectangleMesh(Point(lefBound, botBound), Point(rigBound, topBound), 63, 21) # Mesh generation
mesh = Mesh("/home/Magneto/FEniCSSimulations/AutoWriter/mesh/StrTube.xml")
...
# Inlet boundary region of straight pipe
class StrTube_in(SubDomain):
    def inside(self, x, on_boundary):
        return on_boundary and ((0.21 < x[1] < 0.42 and near(x[0], lefBound)))

# Outlet boundary region of straight pipe
class StrTube_out(SubDomain):
    def inside(self, x, on_boundary):
        return on_boundary and ((0.21 < x[1] < 0.42 and near(x[0], rigBound)))
...
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.22 <= x[1] <= 0.23 and near(x[0], lefBound)))
#class inlet_BC2(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.23 <= x[1] <= 0.24 and near(x[0], lefBound)))
#class inlet_BC3(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.24 <= x[1] <= 0.25 and near(x[0], lefBound)))
#class inlet_BC4(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.25 <= x[1] <= 0.26 and near(x[0], lefBound)))
#class inlet_BC5(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.26 <= x[1] <= 0.27 and near(x[0], lefBound)))
#class inlet_BC6(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.27 <= x[1] <= 0.28 and near(x[0], lefBound)))
#class inlet_BC7(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.28 <= x[1] <= 0.29 and near(x[0], lefBound)))
#class inlet_BC8(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.29 <= x[1] <= 0.30 and near(x[0], lefBound)))
#class inlet_BC9(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.30 <= x[1] <= 0.31 and near(x[0], lefBound)))
#class inlet_BC10(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.31 <= x[1] <= 0.32 and near(x[0], lefBound)))
#class inlet_BC11(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.32 <= x[1] <= 0.33 and near(x[0], lefBound)))
#class inlet_BC12(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.33 <= x[1] <= 0.34 and near(x[0], lefBound)))
#class inlet_BC13(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.34 <= x[1] <= 0.35 and near(x[0], lefBound)))
#class inlet_BC14(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.35 <= x[1] <= 0.36 and near(x[0], lefBound)))
#class inlet_BC15(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.36 <= x[1] <= 0.37 and near(x[0], lefBound)))
#class inlet_BC16(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.37 <= x[1] <= 0.38 and near(x[0], lefBound)))
#class inlet_BC17(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.38 <= x[1] <= 0.39 and near(x[0], lefBound)))
#class inlet_BC18(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.39 <= x[1] <= 0.40 and near(x[0], lefBound)))
#class inlet_BC19(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.40 <= x[1] <= 0.41 and near(x[0], lefBound)))
#class inlet_BC20(SubDomain):
#    def inside(self, x, on_boundary):
#        return on_boundary and ((0.41 <= x[1] <= 0.42 and near(x[0], lefBound)))
...
if __name__ == "__main__":
    ...
    outerFolderName = "output/StrTube_sepSimu_new_next/"
    ...
    for z in range(1): # number of iterations
        ...
        # Straight tube
        outObj = StrTube_out()
        rho = interpolate(Expression("x[1] > 0", degree = 1), A) # Straight tube
               
        Vel_mult = random.uniform(0.0, 1.0) #0.01 # Change here
#        Vel_mult = 1.0
        
        for k in (0, 2, 4, 6): # Degree of "flatness" of inflow profile; 0 is constant, 1 is linear, 2 is parabolic, etc..., Change here
            # Load the velocity boundary condition from previous pipes
            velocity_field = np.load('/home/Magneto/FEniCSSimulations/AutoWriter/output/u000_Field.npy')
            
            # Outlet velocities at each point in direction of x-axis
            velocity_x1 = velocity_field[41, 63, 0]
            velocity_x2 = velocity_field[40, 63, 0]
            velocity_x3 = velocity_field[39, 63, 0]
            velocity_x4 = velocity_field[38, 63, 0]
            velocity_x5 = velocity_field[37, 63, 0]
            velocity_x6 = velocity_field[36, 63, 0]
            velocity_x7 = velocity_field[35, 63, 0]
            velocity_x8 = velocity_field[34, 63, 0]
            velocity_x9 = velocity_field[33, 63, 0]
            velocity_x10 = velocity_field[32, 63, 0]
            velocity_x11 = velocity_field[31, 63, 0]
            velocity_x12 = velocity_field[30, 63, 0]
            velocity_x13 = velocity_field[29, 63, 0]
            velocity_x14 = velocity_field[28, 63, 0]
            velocity_x15 = velocity_field[27, 63, 0]
            velocity_x16 = velocity_field[26, 63, 0]
            velocity_x17 = velocity_field[25, 63, 0]
            velocity_x18 = velocity_field[24, 63, 0]
            velocity_x19 = velocity_field[23, 63, 0]
            velocity_x20 = velocity_field[22, 63, 0]
            
            # Outlet velocities at each point in direction of y-axis
            velocity_y1 = velocity_field[41, 63, 1]
            velocity_y2 = velocity_field[40, 63, 1]
            velocity_y3 = velocity_field[39, 63, 1]
            velocity_y4 = velocity_field[38, 63, 1]
            velocity_y5 = velocity_field[37, 63, 1]
            velocity_y6 = velocity_field[36, 63, 1]
            velocity_y7 = velocity_field[35, 63, 1]
            velocity_y8 = velocity_field[34, 63, 1]
            velocity_y9 = velocity_field[33, 63, 1]
            velocity_y10 = velocity_field[32, 63, 1]
            velocity_y11 = velocity_field[31, 63, 1]
            velocity_y12 = velocity_field[30, 63, 1]
            velocity_y13 = velocity_field[29, 63, 1]
            velocity_y14 = velocity_field[28, 63, 1]
            velocity_y15 = velocity_field[27, 63, 1]
            velocity_y16 = velocity_field[26, 63, 1]
            velocity_y17 = velocity_field[25, 63, 1]
            velocity_y18 = velocity_field[24, 63, 1]
            velocity_y19 = velocity_field[23, 63, 1]
            velocity_y20 = velocity_field[22, 63, 1]
...
#            inVelVal = Expression(('Vel_mult*' + inflowVelExpression(k), '0.0'), Vel_mult = Vel_mult, degree=2) # Inlet velocity
            ...
            folderName = outerFolderName + str(z) + str(i) + str(k) + "/"
            print(folderName)
