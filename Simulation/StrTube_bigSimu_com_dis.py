...
mesh = RectangleMesh(Point(lefBound, botBound), Point(rigBound, topBound), 126, 21) # Mesh generation
#mesh = Mesh("/home/Magneto/FEniCSSimulations/AutoWriter/mesh/Lshape3.xml")
...
if __name__ == "__main__":
    ...
    outerFolderName = "output/GNN_database_dis/GNN_simulation_output/StrTube_bigSimu_com_dis_div/"
    # meshFileXML = File(outerFolderName + "StrTube_big.xml")
    # meshFileXML << mesh
...
#            Vel_mult = 1.0
    for path, _, files in os.walk("output/GNN_database_dis/GNN_simulation_input/StrTube_outVel_npy_next"):
